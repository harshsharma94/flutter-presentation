...
///
/// Built for slide 16's nine-step OAuth2 flow (`/oauth-flow`) and reused,
/// smaller, on slides 17 and 18 — getting the lane/row geometry right once
...
///
/// When [from] equals [to] the hop is a same-lane event (slide 16 step 2,
...
/// 16 step 9's successful retry redraws step 8's failed request in green.
...
class SequenceDiagram extends StatelessWidget {
  ...
  /// to align extra content (slide 16's token pills) with a specific hop
...
/// A same-lane hop's badge (slide 16 step 2: "user logs in", no crossing).
...
/// for slide 16 step 7's silent, unattended expiry.
