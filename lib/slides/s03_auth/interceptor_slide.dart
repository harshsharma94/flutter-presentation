...
/// The same four-step shape as the code beside it — slide 16's diagram,
/// zoomed to just the hops this interceptor triggers.
const _hops = [
  SequenceHop(from: 'app', to: 'api', label: '401', atStep: 1, color: Palette.red),
...
/// Slide 17 — `/auth-interceptor` (4 steps, A12). The code that automates
/// slide 16's steps 7-9: a Dio `onError` interceptor that catches a 401,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Deliberately not width-constrained (matches
              // async_await_slide.dart's CorrelationPanel): it fills
              // whatever width the Column already resolved to from the Row
              // above, which keeps its own height at its natural minimum —
              // constraining it narrower makes its concept text wrap and
              // grow taller, which is what blew the height budget here
