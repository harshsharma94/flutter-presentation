...
const _rows = [
  ...
  CorrelationRow(platform: 'Java / Spring', concept: 'RestTemplate / WebClient'),
  CorrelationRow(platform: 'Go', concept: 'net/http'),
];

/// Slide 7 — `/http-clients` (4 steps, A5). A correlation slide in its own
          ...
          child: Column(
            ...
            children: [
              const Text(
                ...
                style: TextStyle(color: Palette.textPrimary, fontSize: 28),
              ),
